  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col sm:flex-row justify-between gap-8 pt-5 sm:pt-14 min-h-[80vh] border-t">
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        <div className="text-left text-xl sm:text-2xl my-3">
        ...
        <div className="flex gap-3">
          <input onChange={onChangeHandler} name='zip' value={formData.zip} className="border border-gray-300 rounded py-1.5 px-3.5 w-full" type="number" placeholder="Zipcode" />
